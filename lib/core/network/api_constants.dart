...
class ApiConstants {
  ...
  static String actorImages(int actorId) => '$baseUrl/person/$actorId/images';
  static String imageUrl(String imagePath) => 'https://image.tmdb.org/t/p/original$imagePath';
