...
import 'package:my_actors/feature/actors_list/data/models/actors_list_model.dart';
...
class BuildActorItem extends StatelessWidget {
  ...
  const BuildActorItem({super.key, required this.actor});
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                // -------------------------------- ACTOR'S WORK -------------------------------- \\
                Text(actor.knownForDepartment ?? '', style: TextStyle(color: Colors.grey, fontSize: 14.sp)),
              ],
            ),
          ),
